...
- tested only with certain MCNPX, 6.1 and 6.2 tally types
...
* despite different codes, this one has a Graphical User Interface and allows for some basic plot configuration
* the code is written fully in the Python language and will be available on this [link](https://github.com/dusankr/MCNP_TallyPlotter)
* full description is in the next subsections
...
<img src="figures/mcnp_plotter/main_win_empty.PNG" alt=“” width="70%" height="70%" title=“Main window without data”>
...
<img src="figures/mcnp_plotter/main_win_data.PNG" width="70%" height="70%" title="Main window with data">
<img src="figures/mcnp_plotter/excel_export.PNG" alt=“” width="70%" height="70%" title="Exported xlsx file">
...
<img src="figures/mcnp_plotter/plot_win_init_sec.PNG" alt= “” width="70%" height="70%">
...
* X and Y axis settings allows to change a scale between linear and logarithmic
...
* menu button in Data input frame allows to choose a tally for ratio plot. All other tallies are divided by the selected tally. This works only if all tallies in the plot have the same bins.
...
* A Cross-section frame allows to show XS data in the picture with a secondary Y axis.
...
<img src="figures/mcnp_plotter/plot_win_xs-data.PNG" alt= “” width="70%" height="70%">
...
<img src="figures/mcnp_plotter/editor_win_config.PNG" alt= “” width="50%" height="50%">

<img src="figures/mcnp_plotter/editor_win_legend.PNG" alt= “” width="50%" height="50%">
...
<img src="figures/mcnp_plotter/endf_xs_export.PNG" alt= “” width="70%" height="70%">
...
<img src="figures/mcnp_plotter/endf_xs_name.PNG" width="50%" height="50%" title="XS data file example downloaded from ENDF page.">
